...
// For local development, create a .env file with VITE_API_URL=http://localhost:5000/api
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://lms-mern-b20i.onrender.com/api';
